...
// HasBlurts applies the HasEdge predicate on the "blurts" edge.
func HasBlurts() predicate.User {
...
// HasBlurtsWith applies the HasEdge predicate on the "blurts" edge with a given conditions (other predicates).
func HasBlurtsWith(preds ...predicate.Blurt) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newBlurtsStep()
...
// HasLikdBlurts applies the HasEdge predicate on the "likd_blurts" edge.
func HasLikdBlurts() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasLikdBlurtsWith applies the HasEdge predicate on the "likd_blurts" edge with a given conditions (other predicates).
func HasLikdBlurtsWith(preds ...predicate.Blurt) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newLikdBlurtsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasLiksWith(preds ...predicate.Lik) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newLiksStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
